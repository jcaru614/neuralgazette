export const unbiasedNewsArticlePrompt = (article: any) => {
  ...
  Instructions:
  Write an unbiased article based solely on the content of the provided article. 
  
  Your article should aim to present a balanced view of the subject, offering readers a comprehensive understanding of the situation and enabling them to form their own opinions.
